...
const newYearsResolutions = ["hej", "då", "dåre"];
...
const printDogNameUppercase = (dogName) => {
  const nameUpperCase = dogName.toUpperCase();
...
person.favoriteFood = ["taco", "salami", "pizza"];
...
// set its value. Do this to add a new property to the person object with the key `eyeColor`
...
console.log(newdogs.labrador.puppy.name);
